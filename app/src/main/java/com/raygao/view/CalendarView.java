...
public class CalendarView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		String yearMonth = MonthStr[month] +", "+ year;
		canvas.drawText(yearMonth, (colPadding * 6) / 2 - 35, 50, tPaint);

		String[] weekStr = new String[] { "M", "T" , "W", "T", "F", "S", "S"};
