...
public class DiaryAdapter {
   ...
   public SQLiteDatabase getMDb() {
	...
	public Cursor fetchAllDiariesByDate(String selectDate) {
		String sql = "select time_diaries._id,time_diaries.content,event_types.name,time_diaries.hour||' Hrs'||time_diaries.minute||' Mins' as count_time,time_diaries.rate from time_diaries,event_types "
