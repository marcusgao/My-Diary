...
import com.raygao.Main;
import com.raygao.R;
import com.raygao.provider.TypeAdapter;
	...
	private void setBtnListener()
	{
		...
		saveBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (name.equals(""))
				{
			         TimeDiary.dailog("The type cannot be empty!",TypeActivity.this);
					 return;
				}else if(isNameUsed(name))
				{
					TimeDiary.dailog("The type cannot be repeated! Please use another one!",TypeActivity.this);
					 return;
				}else if(_id == 0)
				{
                    /* 添加数据到数据库 */
		...
		delBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				 ...
				 if(isUsed(_id)) {
					 TimeDiary.dailog("The type is currently in use. You cannot delete it!",TypeActivity.this);
					 return;
				}
                    /* 删除数据 */
