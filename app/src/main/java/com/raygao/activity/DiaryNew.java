		...
		confirmButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if ("".equals(mSelectDate)) {
					alertString = "Date cannot be empty!";
				} else if ("".equals(content.trim())) {
					alertString = "Content cannot be empty!";
				} else if (eventTypeId == 0) {
					alertString = "Type cannot be empty!";
				} else if (mHour == 0 && mMinute == 0) {
					alertString = "Time cannot be 0 Hour 0 Min!";
				}

				if (!"".equals(alertString)) {
					new AlertDialog.Builder(DiaryNew.this).setTitle("Hint")
							.setMessage(alertString).setPositiveButton("OK",
